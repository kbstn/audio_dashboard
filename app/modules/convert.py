...
class ConvertModule(BaseModule):
    ...
    def _process_conversion(
        self, files: List[Dict], output_format: str, bitrate: Optional[str], prefix: str
    ) -> None:
    ...
    def process(self, input_file: str) -> str:
        ...
        return convert_audio(
            input_file=input_file, output_file=output_file, format="mp3", bitrate="192k"
        )
